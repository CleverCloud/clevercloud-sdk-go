...
*/
func Triggerkubernetesclusterredeploy(ctx context.Context, c *client.Client, tracer trace.Tracer, ownerId string, clusterId string, requestBody *models.RedeployPayload) client.Response[models.ClusterView] {
