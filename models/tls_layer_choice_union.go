...
func (u TlsLayerChoice) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u TlsLayerChoice) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *TlsLayerChoice) UnmarshalJSON(data []byte) error {
