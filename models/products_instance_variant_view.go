...
// ProductsInstanceVariantView Instance variant view returned after creation.  **Component-name scoped, and this fixes a live sp...
type ProductsInstanceVariantView struct {
