...
// BackendUdpChoice `BackendUDPTransport.Transport` (:145-149).
// Tagged union - can hold one of: map[string]any, map[string]any, map[string]any
type BackendUdpChoice struct {
	raw json.RawMessage
}
...
func (u BackendUdpChoice) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u BackendUdpChoice) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *BackendUdpChoice) UnmarshalJSON(data []byte) error {
