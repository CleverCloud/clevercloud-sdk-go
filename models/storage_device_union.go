...
// StorageDevice Source: ovd server/Storage.scala — StorageDevice
...
func (u StorageDevice) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u StorageDevice) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *StorageDevice) UnmarshalJSON(data []byte) error {
