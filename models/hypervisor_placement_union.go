...
type HypervisorPlacement struct {
	raw json.RawMessage
}
...
func (u HypervisorPlacement) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u HypervisorPlacement) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *HypervisorPlacement) UnmarshalJSON(data []byte) error {
