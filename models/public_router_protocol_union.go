...
// PublicRouterProtocol
// Tagged union - can hold one of: map[string]any
type PublicRouterProtocol struct {
	raw json.RawMessage
}
...
func (u PublicRouterProtocol) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u PublicRouterProtocol) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *PublicRouterProtocol) UnmarshalJSON(data []byte) error {
