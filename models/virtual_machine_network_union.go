...
// VirtualMachineNetwork Source: ovd virtualmachine/Network.scala
...
func (u VirtualMachineNetwork) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u VirtualMachineNetwork) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *VirtualMachineNetwork) UnmarshalJSON(data []byte) error {
