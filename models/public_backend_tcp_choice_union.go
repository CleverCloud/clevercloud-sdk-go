...
func (u PublicBackendTcpChoice) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u PublicBackendTcpChoice) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *PublicBackendTcpChoice) UnmarshalJSON(data []byte) error {
