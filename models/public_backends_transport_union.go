...
// PublicBackendsTransport
// Tagged union - can hold one of: map[string]any, map[string]any
type PublicBackendsTransport struct {
	raw json.RawMessage
}
...
func (u PublicBackendsTransport) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u PublicBackendsTransport) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *PublicBackendsTransport) UnmarshalJSON(data []byte) error {
