...
// KnownQuotaItem The two `QuotaItem` kinds the kubernetes module evaluates.  Source: Quota.scala:107,117 — MillivC...
// Tagged union - can hold one of: map[string]any, map[string]any
type KnownQuotaItem struct {
	raw json.RawMessage
}
...
func (u KnownQuotaItem) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u KnownQuotaItem) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *KnownQuotaItem) UnmarshalJSON(data []byte) error {
