...
// BackendsTransport `Backends.Transport` (:210-213).
// Tagged union - can hold one of: map[string]any, map[string]any
type BackendsTransport struct {
	raw json.RawMessage
}
...
func (u BackendsTransport) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u BackendsTransport) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *BackendsTransport) UnmarshalJSON(data []byte) error {
