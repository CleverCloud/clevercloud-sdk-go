...
// ContainerRegistryTokenView Container Registry Token view returned by the v4 API.  Source: references/legacy/ovd/modules/cont...
type ContainerRegistryTokenView struct {
