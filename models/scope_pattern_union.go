...
// ScopePattern Scope pattern for registry token access control.  Source: references/legacy/ovd/modules/container...
// Tagged union - can hold one of: string, map[string]any, map[string]any
...
func (u *ScopePattern) UnmarshalJSON(data []byte) error {
