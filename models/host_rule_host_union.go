...
// HostRuleHost `HostRule.Host` (:232-235) — the tagged payload is a plain string: `{"type": "Exact", "exact": "e...
// Tagged union - can hold one of: map[string]any, map[string]any
type HostRuleHost struct {
	raw json.RawMessage
}
...
func (u *HostRuleHost) UnmarshalJSON(data []byte) error {
