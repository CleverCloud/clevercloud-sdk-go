...
// RouterProtocol `Router.Protocol` (:353-356) — HTTP is the only variant.
...
func (u RouterProtocol) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u RouterProtocol) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *RouterProtocol) UnmarshalJSON(data []byte) error {
