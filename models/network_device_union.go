...
// NetworkDevice Source: ovd server/Network.scala — NetworkDevice
...
func (u NetworkDevice) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u NetworkDevice) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *NetworkDevice) UnmarshalJSON(data []byte) error {
