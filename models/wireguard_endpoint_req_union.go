...
// WireguardEndpointReq The request for an endpoint, carried by an [`InConstructionPeer`] until the leader allocates the ...
// Tagged union - can hold one of: map[string]any, map[string]any
type WireguardEndpointReq struct {
	raw json.RawMessage
}
...
func (u WireguardEndpointReq) Type() string {
	t, _ := peekType(u.raw)
	return t
}

// MarshalJSON returns the raw JSON payload of the held value, or null if empty.
func (u WireguardEndpointReq) MarshalJSON() ([]byte, error) {
	if u.raw == nil {
...
func (u *WireguardEndpointReq) UnmarshalJSON(data []byte) error {
